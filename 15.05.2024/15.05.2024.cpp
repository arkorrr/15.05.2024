...
public:
    ...
    void SetProcessor()override
    {
        processor = "Intel Pentium Dual-Core E5800 3.20GHz/2M/800";
    }
    void SetMainBoard()override
    {
        mainboard = "Intel B1";
    ...
    void SetHdd()override
    {
        hdd = "Western Digital Elements 256GB";
    }
    void SetMemory()override
    {
        memory = "2 GB DDR3-1600";
    }
};
...
class CreatorPlayerPC : public Creator
{
public:
    PC* FactoryMethod()override
    {
...
void main()
{
    ...
    creators[2] = new CreatorPlayerPC();
    Factory(creators, 3);
}